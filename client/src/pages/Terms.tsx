...
export default function Terms() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <AppHeader>
        <h1 className="text-2xl font-bold">Termini e Condizioni</h1>
      </AppHeader>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
        ...
        <section>
          <h2 className="text-xl font-bold mb-4">Descrizione del Servizio</h2>
          <p className="text-foreground/80 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold mb-4">Account e Autenticazione</h2>
          <p className="text-foreground/80 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold mb-4">Tier Gratuito e Premium</h2>
          <p className="text-foreground/80 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold mb-4">Pagamenti e Abbonamenti</h2>
          <p className="text-foreground/80 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold mb-4">Limitazioni di Responsabilità</h2>
          <p className="text-foreground/80 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold mb-4">Proprietà Intellettuale</h2>
          <p className="text-foreground/80 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold mb-4">Cancellazione Account</h2>
          <p className="text-foreground/80 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold mb-4">Legge Applicabile</h2>
          <p className="text-foreground/80 leading-relaxed">
