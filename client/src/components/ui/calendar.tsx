    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-transparent hover:text-inherit"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-[var(--header-gold)] text-gray-900 hover:bg-[#d4a23f] hover:text-gray-900 focus:bg-[var(--header-gold)] focus:text-gray-900",
