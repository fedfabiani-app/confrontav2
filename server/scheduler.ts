...
export async function initializeScheduledTasks() {
  ...
  // INTEGRATION TEST CRON: Commented out after successful validation
  // Validates database + config + cron work together - Runs every 2 minutes
  // Uncomment to re-test the foundation
